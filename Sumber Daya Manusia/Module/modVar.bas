...
Public mstrPathFileSDM As String
...
Public strIsi As String
Public strIsiGroup As String
...
Public mstrNoRiwayat As String
Public mstrKdStatusAbsensi As String
Public mstrKdKomponenGaji As String
...
Public strSQLsplakuk As String
...
Public rsxx As New ADODB.recordset
Public rsxxx As New ADODB.recordset
Public strQuery As String
Public strsqlx As String
Public strsqlxx As String
Public strsqlxxx As String
Public strSQLc1 As String
...
Public strUserLama As String
Public strFilterPasien As String
Public strTandaTangan As String
Public strNoUrut As String
Public strNoUrutTemp As String
Public TempIdPegawai As String

Public strKdPendidikan As String
Public strKdJabatan As String

Public strTglAkhir As String
Public TempThn As String
Public strTglSK As String
Public strTglSelesai As String
Public strTglPulang As String

'Untuk JOD
Public strNoRequest As String
...
'jadwal kerja
Public glDate As Date
Public glDateCetak As Date

Public subBolTampil As Boolean
Public subIntJmlKomponen As Integer

Public strnonmedis As Boolean

Public rsD As New ADODB.recordset
Public rsH As New ADODB.recordset
Public bolCekStokPesanBarang As Boolean
