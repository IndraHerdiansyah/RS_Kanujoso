...
Begin VB.Form frm_cetak_stokBarangNM 
   Caption         =   "Laporan Cetak Stok Barang"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frm_cetak_stokBarangNM.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frm_cetak_stokBarangNM"
...
Dim Report As New cr_stokBarangNM
...
Private Sub Form_Load()
    ...
    With Report
        ...
        .usStock.SetUnboundFieldSource ("{ado.jmlStokRuangan}")
        .usJenisBarang.SetUnboundFieldSource ("{ado.DetailJenisBarang}")
        .usSatuan.SetUnboundFieldSource ("{ado.SatuanJmlB}")
        .NoRegistrasi.SetUnboundFieldSource ("{ado.NoRegisterAsset}")
    End With
