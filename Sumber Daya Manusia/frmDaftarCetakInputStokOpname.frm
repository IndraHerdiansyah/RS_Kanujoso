...
'Private Sub dcNamaBarangAwal_KeyPress(KeyAscii As Integer)
'    If KeyAscii = 13 Then dcNamaBarangAkhir.SetFocus
'End Sub
...
End Sub
'
'Private Sub txtAreaAwal_KeyPress(KeyAscii As Integer)
'    If KeyAscii = 13 Then dcNamaBarangAwal.SetFocus
'End Sub
