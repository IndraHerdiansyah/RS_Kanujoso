...
Dim Report As New crHariLibur

Private Sub Form_Load()

    Call openConnection
    Set frmHariLibur = Nothing
    Set dbcmd = New ADODB.Command

    With dbcmd
        .ActiveConnection = dbConn
        .CommandText = "SELECT NamaHariLibur,TglHariLibur FROM HariLibur"
        .CommandType = adCmdText
    End With

    With Report
        .Database.AddADOCommand dbConn, dbcmd
        .usNamaHariLibur.SetUnboundFieldSource ("{ado.NamaHariLibur}")
        .usTglHariLibur.SetUnboundFieldSource ("{ado.TglHariLibur}")
