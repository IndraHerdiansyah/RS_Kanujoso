...
Begin VB.Form frmRiwayatUsulanPesiun 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Usulan Pensiun"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatUsulanPesiun.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatUsulanPesiun.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatUsulanPesiun.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatUsulanPesiun.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatUsulanPesiun"
...
Private Sub cmdSimpan_Click()
    ...
    End If
    If Periksa("datacombo", dcStatus, "Silahkan isi nama status usulan ") = False Then Exit Sub
...
Private Sub subLoadRiwayatUsulan()
    ...
    "dbo.RiwayatUsulan.TandaTanganSK, dbo.RiwayatUsulan.KdStatusUsulan, dbo.StatusPegawai.Status, dbo.RiwayatUsulan.KeteranganLainnya, " & _
    "dbo.RiwayatUsulan.NoRiwayatRealisasi " & _
    "FROM dbo.RiwayatUsulan INNER JOIN " & _
    "dbo.StatusPegawai ON dbo.RiwayatUsulan.KdStatusUsulan = dbo.StatusPegawai.KdStatus " & _
    "WHERE (dbo.RiwayatUsulan.KdStatusUsulan IS NOT NULL) " & _
