...
Begin VB.Form frm_cetak_LaporanRiwayatPrestasi 
   Caption         =   "Medifirst2000 - Cetak Riwayat Prestasi"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7950
   Icon            =   "frm_cetak_LaporanRiwayatPrestasi.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   7950
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanRiwayatPrestasi"
...
Dim Report As New crLaporanRiwayatPrestasi
...
Private Sub Form_Load()
    ...
    Me.WindowState = 2
    Set frm_cetak_LaporanRiwayatPrestasi = Nothing
    ...
    TempThn = Format(frmLaporanRiwayatPrestasi.DTPickerAwal.Value, "yyyy")
    TempThn = TempThn - Year(dbRst.Fields("TglSK"))
    ...
    With Report
        ...
        .usPrestasi.SetUnboundFieldSource ("{ado.NamaPenghargaan}")
        ...
        .txtMasaKerja.SetText TempThn & " " & "Tahun "
