...
Begin VB.Form frmPOAKaryawan 
   ...
   MinButton       =   0   'False
   Moveable        =   0   'False
   Picture         =   "frmPOAKaryawan.frx":08CA
   ScaleHeight     =   6540
   ScaleWidth      =   10995
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1560
      Picture         =   "frmPOAKaryawan.frx":150C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
   Begin VB.Image Image2 
      Height          =   975
      Left            =   0
      Picture         =   "frmPOAKaryawan.frx":4F5C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
...
Private Sub cmdSimpan_Click()
    ...
    For i = 1 To dgData.Rows - 2
        With dbcmd
            ...
            .CommandText = "Add_PemakaianObatAlkesKaryawan"
...
On Error GoTo errLoad
    ...
    With dbcmd
        ...
        .ActiveConnection = dbConn
        .CommandText = "Check_StokBarangRuangan"
        .CommandType = adCmdStoredProc
        .Execute
