...
Begin VB.Form frmLaporanStatusCuti 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Laporan Status Pegawai"
   ClientHeight    =   2745
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5595
   ...
   EndProperty
   Icon            =   "frmLaporanStatusCuti.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3840
      Picture         =   "frmLaporanStatusCuti.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1755
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanStatusCuti.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanStatusCuti.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanStatusCuti"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "select * from V_LaporanPegawaiCuti " & _
    " Where month(TglAwal) Between '" & Format(DTPickerAwal, "mm") & " ' and '" & Format(DTPickerAkhir, "mm") & "' and year(TglAwal) Between '" & Format(DTPickerAwal, "yyyy") & " ' and '" & Format(DTPickerAkhir, "yyyy") & "'"
    ...
    frm_cetak_LaporanCutiPegawai.Show
    Exit Sub
errLoad:
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmLaporanStatusCuti = Nothing
End Sub
