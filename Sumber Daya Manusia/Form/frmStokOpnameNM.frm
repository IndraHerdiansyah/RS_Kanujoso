...
Private Sub optAsal_Click()
    ...
    Call msubDcSource(dcCariData, rs, "SELECT KdAsal, NamaAsal FROM AsalBarang where StatusEnabled='1' ORDER BY NamaAsal")
End Sub
...
Private Function sp_DataStokBarangNonMedis(f_KdBarang As String, f_KdAsal As String, _
    ...
    With dbcmd
        ...
        .ActiveConnection = dbConn
'        .CommandText = "AU_DataStokBarangNonMedis"
...
Private Sub txtIsi_LostFocus()
    txtIsi.Visible = False
     If fgData.Col = 4 Then
        fgData.TextMatrix(fgData.row, 13) = fgData.TextMatrix(fgData.row, 3) - fgData.TextMatrix(fgData.row, 4)
        End If
End Sub
