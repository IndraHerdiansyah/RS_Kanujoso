...
Begin VB.Form frmRiwayatTugasMassal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Surat Tugas"
   ClientHeight    =   7965
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12615
   ...
   EndProperty
   Icon            =   "frmRiwayatTugasMassal.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   10800
      Picture         =   "frmRiwayatTugasMassal.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatTugasMassal.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatTugasMassal.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
End
Attribute VB_Name = "frmRiwayatTugasMassal"
...
Private Sub subLoadDcSource()
    ...
    Call msubDcSource(dcDKategory, rs, "SELECT KdDetailKategoryPegawai, DetailKategoryPegawai FROM DetailKategoryPegawai_M ORDER BY DetailKategoryPegawai")
