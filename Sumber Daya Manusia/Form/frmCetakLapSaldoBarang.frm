...
Dim adocomd As New ADODB.Command
    ...
    With Report
        ...
        .unAwal.SetUnboundFieldSource ("{ado.JmlStokAwalPH}")
        .unMasuk.SetUnboundFieldSource ("{ado.JmlTerima}")
        .unKeluar.SetUnboundFieldSource ("{ado.JmlKeluar}")
        .unSaldo.SetUnboundFieldSource Format(("{ado.JmlStokAwalPH} + {ado.JmlTerima} - {ado.JmlKeluar}"), "###,##0")
        .ucNetto.SetUnboundFieldSource Format(("{ado.HargaNetto}"), "###,##0")
        .ucTotal.SetUnboundFieldSource Format(("{ado.JmlStokAwalPH} + {ado.JmlTerima} - {ado.JmlKeluar} * {ado.HargaNetto}"), "###,##0")
    End With
End Sub
