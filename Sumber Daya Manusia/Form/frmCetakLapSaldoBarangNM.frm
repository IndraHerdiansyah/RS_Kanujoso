...
Private Sub LaporanPerBulan()
    ...
    If strGroup = "" Then
        adocomd.CommandText = "SELECT {fn MONTHNAME (TglTransaksi)} AS TglTransaksi, Pabrik, AsalBarang, DetailJenisBarang, StatusBarang, GolonganBarang, NamaBarang, JmlStokAwalPB, JmlTerima, JmlKeluar, HargaNetto FROM V_DataTransaksiBarangNM " & _
...
Private Sub LaporanPerTahun()
    ...
    If strGroup = "" Then
        adocomd.CommandText = "SELECT *, {fn YEAR (TglTransaksi) } AS TglTransaksi, Pabrik, AsalBarang, DetailJenisBarang, StatusBarang, GolonganBarang, NamaBarang, JmlStokAwalPB, JmlTerima, JmlKeluar, HargaNetto FROM V_DataTransaksiBarangNM " & _
