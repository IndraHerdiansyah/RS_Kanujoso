...
Begin VB.Form frmAutoJadwalBackup 
   ...
   ClientTop       =   330
   ClientWidth     =   10215
   Icon            =   "frmAutoJadwalBackup.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frIsiList 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cmbSebanyak 
            Height          =   315
            ItemData        =   "frmAutoJadwalBackup.frx":0CCA
            Left            =   1320
            List            =   "frmAutoJadwalBackup.frx":0CD4
   ...
   Begin VB.Image Image2 
      Height          =   975
      Left            =   0
      Picture         =   "frmAutoJadwalBackup.frx":0CDE
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image3 
      Height          =   945
      Left            =   8640
      Picture         =   "frmAutoJadwalBackup.frx":369F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1635
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmAutoJadwalBackup.frx":4427
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8415
   End
End
Attribute VB_Name = "frmAutoJadwalBackup"
...
Private Sub subSetDC()
    ...
    strSQL = "SELECT KdShift, NamaShift FROM ShiftKerja order by KdShift"
...
'        .TextMatrix(0, 0) = "Shift"
        
'        strSQL = "SELECT KdShift, NamaShift FROM ShiftKerja order by KdShift"
'        Call msubRecFO(rs, strSQL)
'        While Not rs.EOF
'            .Row = .Rows - 1
'            .TextMatrix(.Row, 0) = rs.Fields.Item("NamaShift").Value
'            .Rows = .Rows + 1
'            rs.MoveNext
'        Wend
'        .TextMatrix(1, 0) = "Pagi"
''        .TextMatrix(2, 0) = "Pagi"
''        .TextMatrix(3, 0) = "Pagi"
'        .TextMatrix(2, 0) = "Siang"
'        .TextMatrix(3, 0) = "Malam"
    End With
End Sub
...
'                        l = 1
'                        For k = 1 To 3
'                            intRowNama = funcCariRowShiftKerja(itm.Text, True, l)
...
'    Select Case ShiftKerja
'        Case "Pagi"
'            funcConvertShiftKerjaToNumber = 1
'        Case "Siang"
'            funcConvertShiftKerjaToNumber = 2
'        Case "Malam"
'            funcConvertShiftKerjaToNumber = 3
'        Case "Libur"
'            funcConvertShiftKerjaToNumber = 4
'    End Select
    strSQL = "SELECT KdShift FROM ShiftKerja WHERE NamaShift='" & ShiftKerja & "'"
    Call msubRecFO(rs, strSQL)
    If Not rs.EOF Then
...
'    Select Case NomorShift
'        Case 1
'            funcConvertNumberToShiftKerja = "Pagi"
'        Case 2
'            funcConvertNumberToShiftKerja = "Siang"
'        Case 3
'            funcConvertNumberToShiftKerja = "Malam"
'        Case 4
...
'    End Select
    ...
    strSQL = "SELECT NamaShift FROM ShiftKerja WHERE KdShift='" & strNomorShift & "'"
    Call msubRecFO(rs, strSQL)
    If Not rs.EOF Then
...
Private Sub Form_Load()
    'Me.dcTempatBertugas.Text = frmJadwalKerjaNew.dcTempatBertugas.Text
...
Private Sub lvjadwalkerja_ItemCheck(ByVal Item As MSComctlLib.ListItem)
    ...
    If Not Item.Checked Then
        ...
        Item.SubItems(2) = ""
    Else
        strSQL = "SELECT TOP 2 Shift FROM v_JadwalKerja WHERE" & _
                 " Nama='" & Item.Text & "'" & _
