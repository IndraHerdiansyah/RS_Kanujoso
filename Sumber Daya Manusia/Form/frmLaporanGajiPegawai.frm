...
Begin VB.Form frmLaporanGajiPegawai 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Daftar Penghasilan Pegawai Non PNS"
   ClientHeight    =   2895
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5235
   ...
   EndProperty
   Icon            =   "frmLaporanGajiPegawai.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3480
      Picture         =   "frmLaporanGajiPegawai.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1755
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanGajiPegawai.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanGajiPegawai.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanGajiPegawai"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "SELECT * FROM V_LaporanRincianGajiPegawai ORDER BY NamaLengkap ASC"
