...
Begin VB.Form frmRiwayatUsulanKenaikanGaji 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Usulan Kenaikan Gaji"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatUsulanKenaikanGaji.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatUsulanKenaikanGaji.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatUsulanKenaikanGaji.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatUsulanKenaikanGaji.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatUsulanKenaikanGaji"
...
Private Sub subLoadRiwayatUsulan()
    ...
    strSQL = "SELECT NoRiwayat, IdPegawai, TglSK, NoSK, TandaTanganSK, GajiPokokUsulan, KeteranganLainnya, NoRiwayatRealisasi " & _
    "From dbo.RiwayatUsulan " & _
    "WHERE (GajiPokokUsulan Is Not Null) AND (KdDKategoryPUsulan Is Null) " & _
