...
Begin VB.Form frmUsulanRealisasiSetuju 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Realisasi Usulan Pegawai"
   ClientHeight    =   7620
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12615
   ...
   EndProperty
   Icon            =   "frmUsulanRealisasiSetuju.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   ScaleHeight     =   7620
   ScaleWidth      =   12615
   Begin VB.TextBox txtNoUrutGaji 
      Height          =   315
      Left            =   8040
      MaxLength       =   10
      TabIndex        =   40
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Surat Keputusan Realisasi Usualan"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   10800
      Picture         =   "frmUsulanRealisasiSetuju.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmUsulanRealisasiSetuju.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmUsulanRealisasiSetuju.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
End
Attribute VB_Name = "frmUsulanRealisasiSetuju"
...
Private Sub cmdSimpan_Click()
    ...
    For i = 1 To fgData.Rows - 2
        If option1.Value = True Then
            '' insert ke Detail Riwayat Usulan
            ...
            With adoComm
                ...
                .Parameters.Append .CreateParameter("KdDKategoryPDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("GajiPokokDiSetujui", adCurrency, adParamInput, , Null)
                .Parameters.Append .CreateParameter("KdPangkatDiSetujui", adVarChar, adParamInput, 2, fgData.TextMatrix(i, 14))
                .Parameters.Append .CreateParameter("NoRiwayatUsulan", adChar, adParamInput, 10, substrNoRiwayat)
                .Parameters.Append .CreateParameter("TotalPaguDiSetujui", adCurrency, adParamInput, , Null)
                .Parameters.Append .CreateParameter("BankPenyalurDiSetujui", adVarChar, adParamInput, 50, Null)
                ...
                .CommandText = "Add_HRD_DetailRRealisasiUsulan"
            ...
            With adoCommand
                .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
                .Parameters.Append .CreateParameter("IdPegawai", adChar, adParamInput, 10, fgData.TextMatrix(i, 0))
                If txtNoUrutPangkat.Text <> "" Then
                    .Parameters.Append .CreateParameter("NoUrut", adChar, adParamInput, 2, txtNoUrutPangkat.Text)
                Else
                    .Parameters.Append .CreateParameter("NoUrut", adChar, adParamInput, 2, Null)
                End If
                .Parameters.Append .CreateParameter("KdPangkat", adVarChar, adParamInput, 2, fgData.TextMatrix(i, 14))
                ...
                End If
                .Parameters.Append .CreateParameter("TandaTanganSK", adVarChar, adParamInput, 30, IIf(txtTTDSK.Text = "", Null, Trim(txtTTDSK.Text)))
                ...
                If IsNull(dtpMulai.Value) Then
                    .Parameters.Append .CreateParameter("TMT", adDate, adParamInput, , Null)
                Else
                    .Parameters.Append .CreateParameter("TMT", adDate, adParamInput, , Format(dtpMulai.Value, "yyyy/MM/dd"))
                End If
                ...
                If Not (.Parameters("RETURN_VALUE").Value = 0) Then
                    MsgBox "Ada kesalahan dalam penyimpanan ke Riwayat Pangkat", vbCritical, "Validasi"
                    Call deleteADOCommandParameters(adoCommand)
                    Set adoCommand = Nothing
                    Exit Sub
                Else
                    txtNoUrutPangkat.Text = .Parameters("OutputNoUrut").Value
                    MsgBox "Data berhasil disimpan ", vbInformation, "Informasi"
                End If
                Call deleteADOCommandParameters(adoCommand)
                Set adoCommand = Nothing
        ...
        If Option2.Value = True Then
            ...
            With adoComm
                ...
                .Parameters.Append .CreateParameter("KdStatusDiSetujui", adChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("KdDKategoryPDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("GajiPokokDiSetujui", adCurrency, adParamInput, , Val(fgData.TextMatrix(i, 6)))
        ...
        If Option3.Value = True Then
            ...
            With adoComm
                ...
                .Parameters.Append .CreateParameter("IdPegawai", adChar, adParamInput, 10, fgData.TextMatrix(i, 0))
                .Parameters.Append .CreateParameter("TugasPekerjaan", adVarChar, adParamInput, 150, Null)
                .Parameters.Append .CreateParameter("KdStatusDiSetujui", adChar, adParamInput, 2, fgData.TextMatrix(i, 11))
                .Parameters.Append .CreateParameter("KdDKategoryPDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("GajiPokokDiSetujui", adCurrency, adParamInput, , Null)
                .Parameters.Append .CreateParameter("KdPangkatDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("NoRiwayatUsulan", adChar, adParamInput, 10, substrNoRiwayat)
        ...
        If Option4.Value = True Then
            ...
            With adoComm
                ...
                .Parameters.Append .CreateParameter("KdPangkatDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("NoRiwayatUsulan", adChar, adParamInput, 10, substrNoRiwayat)
                .Parameters.Append .CreateParameter("TotalPaguDiSetujui", adCurrency, adParamInput, , Val(fgData.TextMatrix(i, 8)))
                .Parameters.Append .CreateParameter("BankPenyalurDiSetujui", adVarChar, adParamInput, 50, fgData.TextMatrix(i, 9))
                .Parameters.Append .CreateParameter("KeteranganLainnya", adVarChar, adParamInput, 100, IIf(fgData.TextMatrix(i, 15) = "", Null, Trim(fgData.TextMatrix(i, 15))))
        ...
        If option6.Value = True Then
            ...
            With adoComm
                ...
                .Parameters.Append .CreateParameter("TugasPekerjaan", adVarChar, adParamInput, 150, IIf(fgData.TextMatrix(i, 2) = "", Null, fgData.TextMatrix(i, 2)))
                .Parameters.Append .CreateParameter("KdStatusDiSetujui", adChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("KdDKategoryPDiSetujui", adVarChar, adParamInput, 2, fgData.TextMatrix(i, 13))
                .Parameters.Append .CreateParameter("GajiPokokDiSetujui", adCurrency, adParamInput, , Val(fgData.TextMatrix(i, 6)))
                .Parameters.Append .CreateParameter("KdPangkatDiSetujui", adVarChar, adParamInput, 2, Null)
                .Parameters.Append .CreateParameter("NoRiwayatUsulan", adChar, adParamInput, 10, substrNoRiwayat)
                .Parameters.Append .CreateParameter("TotalPaguDiSetujui", adCurrency, adParamInput, , Null)
...
Private Sub dtpAkhir_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then dtpSetuju.SetFocus
End Sub
    ...
    If KeyAscii = 13 Then
        Select Case fgData.Col
            ...
            Case 8
                ...
                End If
                With fgData
                    .TextMatrix(.Row, fgData.Col) = txtIsi.Text
                    If .TextMatrix(.Rows - 1, 2) = "" Then
                        .Row = .Rows - 1
                        .Col = 1
                    Else
...
Private Function sp_RiwayatGaji() As Boolean
    ...
    With adoCommand
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("IdPegawai", adChar, adParamInput, 10, fgData.TextMatrix(i, 0))
        If txtNoUrutGaji.Text <> "" Then
            .Parameters.Append .CreateParameter("NoUrut", adChar, adParamInput, 2, txtNoUrutGaji.Text)
        Else
            .Parameters.Append .CreateParameter("NoUrut", adChar, adParamInput, 2, Null)
        End If
        .Parameters.Append .CreateParameter("NoSK", adVarChar, adParamInput, 30, IIf(txtNoSK.Text = "", Null, Trim(txtNoSK.Text)))
        ...
        Else
            .Parameters.Append .CreateParameter("TglBerlakuSK", adDate, adParamInput, , Format(dtpMulai.Value, "yyyy/MM/dd"))
        End If
        .Parameters.Append .CreateParameter("MasaKerja", adVarChar, adParamInput, 50, Null)
        .Parameters.Append .CreateParameter("TandaTanganSK", adVarChar, adParamInput, 30, IIf(txtTTDSK.Text = "", Null, Trim(txtTTDSK.Text)))
        .Parameters.Append .CreateParameter("Keterangan", adVarChar, adParamInput, 200, IIf(txtKeterangan.Text = "", Null, Trim(txtKeterangan.Text)))
        .Parameters.Append .CreateParameter("IdUser", adChar, adParamInput, 10, strIDPegawai)
        .Parameters.Append .CreateParameter("OutputNoUrut", adChar, adParamOutput, 2, Null)
        ...
        Else
            txtNoUrutGaji.Text = .Parameters("OutputNoUrut").Value
...
Private Function sp_RiwayatDetailGaji() As Boolean
    ...
    With adoCommand
        ...
        .Parameters.Append .CreateParameter("IdPegawai", adChar, adParamInput, 10, fgData.TextMatrix(i, 0))
        .Parameters.Append .CreateParameter("NoUrut", adChar, adParamInput, 2, txtNoUrutGaji.Text)
        .Parameters.Append .CreateParameter("KdKomponenGaji", adChar, adParamInput, 2, "01")
        .Parameters.Append .CreateParameter("Jumlah", adCurrency, adParamInput, , Val(fgData.TextMatrix(i, 6)))
