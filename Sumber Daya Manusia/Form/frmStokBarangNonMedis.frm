...
'    kodebarang = dgBrg.Columns(1)
'    kodeasal = dgBrg.Columns(9)
'    tempbolTampil = True
'    txtNamaBrg = dgBrg.Columns(2)
'    tempbolTampil = False
'    dcAsalBrg.Text = dgBrg.Columns(3)
'    txtJmlMin = dgBrg.Columns(4)
'    txtJmlStok = dgBrg.Columns(5)
'    txtLokasi = dgBrg.Columns(7)
'    frameDataBrg.Visible = False
'    strkdbarang = dgBrg.Columns(1)
...
On Error GoTo errLoad
    ...
    With dgBrg
        ...
        .Columns(14).Width = 0
        .Columns(15).Width = 0
        .Columns("NoRegisterAsset").Width = 1800
