...
Begin VB.Form frm_cetak_LaporanNominatifTPHL 
   Caption         =   "Medifirst2000 - Cetak Laporan Tahunan Nomatif Pegawai"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8685
   Icon            =   "frm_cetak_LaporanNominatifTPHL.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   8685
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanNominatifTPHL"
...
Dim Report As New crLaporanNominatifTPHL

Private Sub Form_Load()
    On Error GoTo errLoad
    Screen.MousePointer = vbHourglass
    Me.WindowState = 2
    Set frm_cetak_LaporanNominatifTPHL = Nothing
    ...
    With Report
        ...
        .udTglSK1.SetUnboundFieldSource ("{ado.TglSK}")
        .udTMT1.SetUnboundFieldSource ("{ado.TglBerlaku}")
        .usNoSK2.SetUnboundFieldSource ("{ado.NoSK}")
        .udTglSk2.SetUnboundFieldSource ("{ado.TglSK}")
        .udTMT2.SetUnboundFieldSource ("{ado.TglBerlaku}")
        .usNoPerjantian.SetUnboundFieldSource ("{ado.NoSK}")
        .usTugasPekerjaan.SetUnboundFieldSource ("{ado.TugasPekerjaan}")
