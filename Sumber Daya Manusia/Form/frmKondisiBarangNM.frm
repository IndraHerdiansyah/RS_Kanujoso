...
'    dbConn.Execute "DELETE KondisiBarangNonMedis WHERE KdRuangan = '" & mstrKdRuangan & "' AND KdBarang ='" & txtKdBarang.Text & "' AND KdAsal='" & dcAsalBarang.BoundText & "' AND KdKondisi='" & dcKondisiBarang.BoundText & "' AND JmlBarang='" & txtJmlBarang.Text & "' AND NoRegisterAsset ='" & NoRegister & "' "
    If sp_KondisiBarangNonMedis("D") = False Then Exit Sub
    Call cmdBatal_Click
...
On Error GoTo Errload
    ...
    If sp_KondisiBarangNonMedis("A") = False Then Exit Sub
...
On Error GoTo Errload
    ...
    With dgCariBarang
       ...
       txtStok.Text = .Columns("jmlStok")
        ...
        txtNoReg.Text = .Columns("NoRegisterAsset").Value
        NoRegister = .Columns("NoRegisterAsset").Value
        txtKdBarang.Text = .Columns("KdBarang").Value
...
On Error GoTo Errload
    ...
    With dgKondisiBarang
        ...
        txtNoReg = .Columns("NoRegisterAsset")
        txtNamaBarang.Text = .Columns("Nama Barang")
    End With
...
Private Function sp_KondisiBarangNonMedis(f_status As String) As Boolean
On Error GoTo Errload
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoRegistrasiAsset", adVarChar, adParamInput, 15, txtNoReg.Text)
