...
Begin VB.Form frm_cetak_LaporanGajiBerkala 
   Caption         =   "Cetak Kenaikan Gaji Berkala"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frm_cetak_LaporanGajiBerkala.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanGajiBerkala"
...
Dim Report As New crLaporanRiwayatGajiBerkala

Private Sub Form_Load()
    Screen.MousePointer = vbHourglass
    Me.WindowState = 2
    Set frm_cetak_LaporanGajiBerkala = Nothing
    ...
    If frmLaporanGajiBerkala.option1.Value = True Then
        Report.txtTanggal1.SetText Format(frmLaporanGajiBerkala.DTPickerAwal.Value, "MMMM yyyy")
    ElseIf frmLaporanGajiBerkala.Option2.Value = True Then
        Report.txtTanggal1.SetText Format(frmLaporanGajiBerkala.DTPickerAwal.Value, "yyyy")
    End If
    ...
    Report.ucGaji.SetUnboundFieldSource ("{ado.Jumlah}")
