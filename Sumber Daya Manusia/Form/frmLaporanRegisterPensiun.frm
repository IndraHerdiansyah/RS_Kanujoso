...
Begin VB.Form frmLaporanRegisterPensiun 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Laporan Register Pensiun Pegawai"
   ClientHeight    =   2745
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5595
   ...
   EndProperty
   Icon            =   "frmLaporanRegisterPensiun.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3840
      Picture         =   "frmLaporanRegisterPensiun.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1755
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanRegisterPensiun.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanRegisterPensiun.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanRegisterPensiun"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "select * from v_LaporanRegisterPensiun " & _
    ...
    frm_cetak_LaporanRegisterPensiun.Show
    Exit Sub
errLoad:
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmLaporanRegisterPensiun = Nothing
End Sub
