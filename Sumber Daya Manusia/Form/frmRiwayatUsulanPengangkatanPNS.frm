...
Begin VB.Form frmRiwayatUsulanPengangkatanPNS 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Usulan Pengangkatan Pegawai Negeri Sipil"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatUsulanPengangkatanPNS.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraPerjalanan 
      ...
      Begin VB.Label Label7 
         AutoSize        =   -1  'True
         Caption         =   "Detail Kategory Pegawai Usulan "
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatUsulanPengangkatanPNS.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatUsulanPengangkatanPNS.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatUsulanPengangkatanPNS.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatUsulanPengangkatanPNS"
...
Private Sub cmdSimpan_Click()
    ...
    End If
    If Periksa("datacombo", dcDetailKategory, "Silahkan isi detail kategori pegawai usulan ") = False Then Exit Sub
...
Private Sub subLoadRiwayatUsulan()
    ...
    "dbo.RiwayatUsulan.TandaTanganSK, dbo.RiwayatUsulan.KdDKategoryPUsulan, dbo.DetailKategoryPegawai_M.DetailKategoryPegawai, " & _
    "dbo.RiwayatUsulan.GajiPokokUsulan , dbo.RiwayatUsulan.KeteranganLainnya, dbo.RiwayatUsulan.NoRiwayatRealisasi " & _
    "FROM dbo.RiwayatUsulan INNER JOIN " & _
    "dbo.DetailKategoryPegawai_M ON dbo.RiwayatUsulan.KdDKategoryPUsulan = dbo.DetailKategoryPegawai_M.KdDetailKategoryPegawai " & _
    "WHERE (dbo.RiwayatUsulan.KdDKategoryPUsulan IS NOT NULL) " & _
...
Private Function sp_RiwayatUsulan() As Boolean
    ...
    With adoComm
        ...
        .Parameters.Append .CreateParameter("KdDKategoryPUsulan", adVarChar, adParamInput, 2, dcDetailKategory.BoundText)
        .Parameters.Append .CreateParameter("GajiPokokUsulan", adCurrency, adParamInput, , CCur(txtGaji.Text))
