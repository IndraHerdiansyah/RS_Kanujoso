...
Begin VB.Form frmLaporanSaldoBarang_v3 
   ...
   EndProperty
   Icon            =   "frmLaporanSaldoBarang_v3.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanSaldoBarang_v3.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image2 
      Height          =   945
      Left            =   11160
      Picture         =   "frmLaporanSaldoBarang_v3.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1635
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanSaldoBarang_v3.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11175
   End
End
Attribute VB_Name = "frmLaporanSaldoBarang_v3"
...
Private Sub chkGroupBy_Click()
    If chkGroupBy.Value = vbChecked Then
        ...
        Select Case chkGroupBy.Caption
            Case "Jenis Barang"
'                Call msubDcSource(dcGroupBy, rs, "Select KdJenisBarang,JenisBarang From JenisBarang Where KdKelompokBarang = '01'")
...
Dim sFltrSaldoBy As String
    ...
    'MsgBox "Mohon menunggu beberapa saat hingga proses berhasil", vbExclamation, "Peringatan"
    ...
    If intHr = 0 Then
        ...
        If intBln = 0 Then
            ...
            'intTglNow = funcHitungHari(intBln, CInt(Year(dtTgl)) - 1)
    ...
    For i = 1 To rs.RecordCount
        ...
        With fgData
'            .TextMatrix(i, 1) = rs("KdBarang")
'            .TextMatrix(i, 2) = rs("KdAsal")
            
'            If optHari.Value = True Then
'                strSQL = "SELECT KdBarang, KdAsal,NamaBarang,NamaAsal, CASE (SELECT SIGN(SUM(JmlStok)) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 00:00:00") & "' AND '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') " & _
'                         "WHEN -1 THEN 0 WHEN 0 THEN 0 WHEN 1 THEN (SELECT SUM(JmlStok) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 00:00:00") & "' AND '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') ELSE 0 END AS SaldoAwal, SUM(JmlTerima) AS JmlTerima, SUM(JmlKeluar) AS JmlKeluar, HargaNetto, JenisBarang, NamaBahanBarang, NamaType, NamaMerk, WarnaBarang " & _
'                         "FROM LaporanSaldoBarangNonMedisGdUmum_V " & _
...
'                         "GROUP BY KdBarang, KdAsal, HargaNetto, NamaBarang, NamaAsal, JenisBarang, NamaBahanBarang, NamaType, NamaMerk, WarnaBarang"
'            ElseIf optBulan.Value = True Then
'                strSQL = "SELECT KdBarang, KdAsal,NamaBarang,NamaAsal, CASE (SELECT SIGN(SUM(JmlStok)) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(intThn & "/" & intBln & "/01", "yyyy/MM/dd 00:00:00") & "' AND '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') " & _
'                         "WHEN -1 THEN 0 WHEN 0 THEN 0 WHEN 1 THEN (SELECT SUM(JmlStok) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(intThn & "/" & intBln & "/01", "yyyy/MM/dd 00:00:00") & "' AND '" & Format(intThn & "/" & intBln & "/" & intTgl, "yyyy/MM/dd 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') ELSE 0 END AS SaldoAwal, SUM(JmlTerima) AS JmlTerima, SUM(JmlKeluar) AS JmlKeluar, HargaNetto, JenisBarang, NamaBahanBarang, NamaType, NamaMerk, WarnaBarang " & _
'                         "FROM LaporanSaldoBarangNonMedisGdUmum_V " & _
...
'                         "GROUP BY KdBarang, KdAsal, HargaNetto, NamaBarang, NamaAsal, JenisBarang, NamaBahanBarang, NamaType, NamaMerk, WarnaBarang"
'            ElseIf optTahun.Value = True Then
'                strSQL = "SELECT KdBarang, KdAsal,NamaBarang,NamaAsal, CASE (SELECT SIGN(SUM(JmlStok)) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(mdTglAwal, "yyyy/01/01 00:00:00") & "' AND '" & Format(mdTglAkhir, "yyyy/12/" & tgl & " 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') " & _
'                         "WHEN -1 THEN 0 WHEN 0 THEN 0 WHEN 1 THEN (SELECT SUM(JmlStok) FROM LaporanSaldoBarangNonMedisGdUmum_V WHERE TglTerima BETWEEN '" & Format(mdTglAwal, "yyyy/01/01 00:00:00") & "' AND '" & Format(mdTglAkhir, "yyyy/12/" & tgl & " 23:59:59") & "' AND KdBarang = '" & rs("KdBarang") & "' AND KdAsal='" & rs("KdAsal") & "') ELSE 0 END AS SaldoAwal, SUM(JmlTerima) AS JmlTerima, SUM(JmlKeluar) AS JmlKeluar, HargaNetto, JenisBarang, NamaBahanBarang, NamaType, NamaMerk, WarnaBarang " & _
'                         "FROM LaporanSaldoBarangNonMedisGdUmum_V " & _
...
'            If dbRst.EOF = False Then dbRst.MoveFirst
'            For j = 1 To dbRst.RecordCount
                ...
                ElseIf optTahun.Value = True Then
                    strSQL = "SELECT dbo.StrukKirim.TglKirim, SUM(dbo.DetailBarangNonMedisKeluar.JmlKirim) AS JmlKirim, dbo.StrukKirim.KdRuangan " & _
                             ...
                             "GROUP BY dbo.StrukKirim.TglKirim, dbo.StrukKirim.KdRuangan "
                End If
                Call msubRecFO(rsz, strSQL)
                If rsz.EOF = True Then
                    .TextMatrix(i, 7) = 0
                Else
                    .TextMatrix(i, 7) = rsz("JmlKirim")
                End If
...
Dim sQuery As String
On Error Resume Next
'    sQuery = "drop Table V_LapGudang_NewTemp" & "_" & strNamaHostLocal & ""
'    dbConn.Execute sQuery
