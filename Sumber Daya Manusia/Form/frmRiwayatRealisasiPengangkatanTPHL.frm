...
Begin VB.Form frmRiwayatRealisasiPengangkatanTPHL 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Realisasi Pengangkatan Pegawai TPHL"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatRealisasiPengangkatanTPHL.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatRealisasiPengangkatanTPHL.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatRealisasiPengangkatanTPHL.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatRealisasiPengangkatanTPHL.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatRealisasiPengangkatanTPHL"
...
Private Sub cmdSimpan_Click()
    ...
    If Periksa("datacombo", dcStatus, "Status kosong ") = False Then Exit Sub
...
Private Sub dgData_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    With dgData
        ...
        If IsNull(.Columns(9).Value) Then dtpSetuju.Value = Null Else dtpSetuju.Value = .Columns(9).Value
        If IsNull(.Columns(10).Value) Then dtpBerlaku.Value = Null Else dtpBerlaku.Value = .Columns(10).Value
...
Private Sub subLoadRiwayatRealisasi()
    ...
    strSQL = "SELECT dbo.RiwayatRealisasiUsulan.NoRiwayat, dbo.RiwayatRealisasiUsulan.IdPegawai, dbo.RiwayatRealisasiUsulan.TglSK, dbo.RiwayatRealisasiUsulan.NoSK, " & _
    "dbo.RiwayatRealisasiUsulan.TandaTanganSK, dbo.RiwayatRealisasiUsulan.TugasPekerjaan, dbo.RiwayatRealisasiUsulan.KdStatusDiSetujui, dbo.StatusPegawai.Status, " & _
    "dbo.RiwayatRealisasiUsulan.KeteranganLainnya, dbo.RiwayatRealisasiUsulan.TglDiSetujui, dbo.RiwayatRealisasiUsulan.TglBerlaku " & _
    "FROM dbo.RiwayatRealisasiUsulan INNER JOIN " & _
    "dbo.StatusPegawai ON dbo.RiwayatRealisasiUsulan.KdStatusDiSetujui = dbo.StatusPegawai.KdStatus " & _
    "WHERE (dbo.RiwayatRealisasiUsulan.KdStatusDiSetujui IS NOT NULL) " & _
    "AND dbo.RiwayatRealisasiUsulan.IdPegawai = '" & mstrIdPegawai & "' "
    Set rsb = Nothing
    ...
    With dgData
        ...
        .Columns(9).Width = 1500 'tgl disetujui
        .Columns(10).Width = 1500 'tgl berlaku
...
Private Function sp_RiwayatRealisasi() As Boolean
    ...
    With adoComm
        ...
        .Parameters.Append .CreateParameter("KdStatusDiSetujui", adChar, adParamInput, 2, dcStatus.BoundText)
