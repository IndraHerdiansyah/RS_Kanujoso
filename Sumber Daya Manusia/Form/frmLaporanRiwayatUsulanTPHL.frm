...
Begin VB.Form frmLaporanRiwayatUsulanTPHL 
   ...
   EndProperty
   Icon            =   "frmLaporanRiwayatUsulanTPHL.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   2880
      Picture         =   "frmLaporanRiwayatUsulanTPHL.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1155
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanRiwayatUsulanTPHL.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanRiwayatUsulanTPHL.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanRiwayatUsulanTPHL"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "select * from V_RiwayatUsulanPengangkatanTPHL_Detail where year(TglRiwayat) = '" & Format(DTPickerAwal.Value, "yyyy") & "' "
...
'    frm_cetak_LaporanUsulanTPHL.Show
    Exit Sub
errLoad:
End Sub
