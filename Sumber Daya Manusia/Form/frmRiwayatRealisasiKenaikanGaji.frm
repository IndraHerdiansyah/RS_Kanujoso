...
Begin VB.Form frmRiwayatRealisasiKenaikanGaji 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Realisasi Kenaikan Gaji Berkala"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatRealisasiKenaikanGaji.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatRealisasiKenaikanGaji.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatRealisasiKenaikanGaji.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatRealisasiKenaikanGaji.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatRealisasiKenaikanGaji"
...
Private Sub cmdSimpan_Click()
    ...
    If Periksa("text", txtGaji, "Jumlah gaji kosong ") = False Then Exit Sub
...
Private Sub dgData_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    With dgData
        ...
        If IsNull(.Columns(6).Value) Then txtKeterangan.Text = "" Else txtKeterangan.Text = .Columns(6).Value
        txtGaji.Text = .Columns(5).Value
        If IsNull(.Columns(7).Value) Then dtpSetuju.Value = Null Else dtpSetuju.Value = .Columns(7).Value
        If IsNull(.Columns(8).Value) Then dtpBerlaku.Value = Null Else dtpBerlaku.Value = .Columns(8).Value
...
Private Sub subLoadRiwayatRealisasi()
    ...
    strSQL = "SELECT NoRiwayat, IdPegawai, TglSK, NoSK, TandaTanganSK, GajiPokokDiSetujui, KeteranganLainnya, TglDiSetujui, TglBerlaku " & _
    "From dbo.RiwayatRealisasiUsulan " & _
    "WHERE (GajiPokokDiSetujui Is Not Null) AND KdDKategoryPDiSetujui IS NULL " & _
    ...
    With dgData
        ...
        .Columns(5).Width = 1500 'gaji
        .Columns(6).Width = 2000 'keterangan
        .Columns(7).Width = 1000 'tgl disetujui
        .Columns(8).Width = 1000 'tgl berlaku
    End With
    Exit Sub
errLoad:
    Call msubPesanError
