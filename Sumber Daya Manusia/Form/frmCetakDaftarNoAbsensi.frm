...
Begin VB.Form frmCetakDaftarNoAbsensi 
   Caption         =   "frmCetakDaftarNoAbsensi"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frmCetakDaftarNoAbsensi.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmCetakDaftarNoAbsensi"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New crDaftarNoAbsensi
...
Private Sub Form_Load()
    ...
    With Report
        ...
        .unNoAbsensi.SetUnboundFieldSource ("{ado.NoAbsensi}")
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCetakDaftarNoAbsensi = Nothing
End Sub
