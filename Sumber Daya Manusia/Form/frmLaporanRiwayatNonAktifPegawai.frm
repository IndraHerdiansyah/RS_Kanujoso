...
Begin VB.Form frmLaporanRiwayatNonAktifPegawai 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Laporan Riwayat Non Aktif Pegawai"
   ClientHeight    =   2745
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5595
   ...
   EndProperty
   Icon            =   "frmLaporanRiwayatNonAktifPegawai.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3840
      Picture         =   "frmLaporanRiwayatNonAktifPegawai.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1755
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanRiwayatNonAktifPegawai.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanRiwayatNonAktifPegawai.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanRiwayatNonAktifPegawai"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "select * from v_LaporanPenonaktifanPegawai " & _
    ...
    frm_cetak_LaporanNonAktifPegawai.Show
    Exit Sub
errLoad:
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmLaporanRiwayatNonAktifPegawai = Nothing
End Sub
