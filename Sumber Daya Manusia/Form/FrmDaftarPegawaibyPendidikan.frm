...
Begin VB.Form FrmDaftarPegawaibyPendidikan 
   ...
   EndProperty
   Icon            =   "FrmDaftarPegawaibyPendidikan.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3600
      Picture         =   "FrmDaftarPegawaibyPendidikan.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1755
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "FrmDaftarPegawaibyPendidikan.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11535
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "FrmDaftarPegawaibyPendidikan.frx":30B0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
End
Attribute VB_Name = "FrmDaftarPegawaibyPendidikan"
