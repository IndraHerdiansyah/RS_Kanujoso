...
Begin VB.Form frm_cetak_LaporanNominatif 
   Caption         =   "Medifirst2000 - Cetak Laporan Tahunan Nomatif Pegawai"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7950
   Icon            =   "frm_cetak_LaporanNominatif.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   7950
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanNominatif"
...
Dim Report As New crLaporanNominatif

Private Sub Form_Load()
    On Error GoTo errLoad
    Screen.MousePointer = vbHourglass
    Me.WindowState = 2
    Set frm_cetak_LaporanNominatif = Nothing
    ...
    With Report
        ...
        .usGolongan.SetUnboundFieldSource ("{ado.Gol}")
        .usJabatan.SetUnboundFieldSource ("{ado.NamaJabatan}")
        .usJenjang.SetUnboundFieldSource ("{ado.NamaJenjangJabatan}")
