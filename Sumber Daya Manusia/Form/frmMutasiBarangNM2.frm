...
Private Sub subLoadDcSource()
    ...
    Call msubDcSource(dcAsalBarang, rs, "SELECT KdAsal, NamaAsal FROM AsalBarang ORDER BY NamaAsal")
    Call msubDcSource(dcRuanganPenerima, rs, "SELECT KdRuangan, NamaRuangan FROM Ruangan ORDER BY NamaRuangan")
...
Private Sub subLoadGridSource()
    ...
    " WHERE [Nama Barang] LIKE '%" & txtCariBarang & "%'"
    Call msubRecFO(rs, strSQL)
