...
Private Sub dgObatAlkes_DblClick()
    ...
    'repaied kurang null di sintax sql
    strSQL = "Select dbo.FB_TakeHargaNettoOA('2222222222','01', '" & dgObatAlkes.Columns("KdBarang") & "','" & dgObatAlkes.Columns("KdAsal") & "', '" & dgObatAlkes.Columns("Satuan") & "', '" & mstrKdRuangan & "', null) as HargaBarang"
    Set dbRst = Nothing
    Call msubRecFO(dbRst, strSQL)
    fgAlkes.TextMatrix(fgAlkes.row, 6) = dbRst("HargaBarang")
    ...
    fgAlkes.TextMatrix(fgAlkes.row, 7) = dbRst("HargaBarang")
    fgAlkes.TextMatrix(fgAlkes.row, 8) = dbRst("HargaBarang")
    fgAlkes.SetFocus
    fgAlkes.Col = 4
