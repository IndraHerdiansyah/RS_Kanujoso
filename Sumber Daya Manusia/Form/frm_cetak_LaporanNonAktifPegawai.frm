...
Begin VB.Form frm_cetak_LaporanNonAktifPegawai 
   Caption         =   "Medifirst2000 - Cetak Laporan Pegawai Non Aktif"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7950
   Icon            =   "frm_cetak_LaporanNonAktifPegawai.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   7950
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanNonAktifPegawai"
...
Dim Report As New crLaporanRiwayatUsulanNonAktif

Private Sub Form_Load()
    On Error GoTo errLoad
    Screen.MousePointer = vbHourglass
    Me.WindowState = 2
    Set frm_cetak_LaporanNonAktifPegawai = Nothing
    ...
    With Report
        ...
        .usJenisNonAktif.SetUnboundFieldSource ("{ado.JenisStatus}")
