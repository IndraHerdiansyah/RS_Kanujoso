...
Begin VB.Form frmLaporanGajiBerkala 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Laporan Riwayat Gaji Berkala"
   ClientHeight    =   2895
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5565
   ...
   EndProperty
   Icon            =   "frmLaporanGajiBerkala.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   4440
      Picture         =   "frmLaporanGajiBerkala.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1155
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanGajiBerkala.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanGajiBerkala.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanGajiBerkala"
...
Private Sub cmdCetak_Click()
    ...
    If Option1.Value = True Then
        ...
        strSQL = "select * from V_LaporanRiwayatGajiBerkala " & _
    ...
    frm_cetak_LaporanGajiBerkala.Show
    Exit Sub
errLoad:
End Sub
