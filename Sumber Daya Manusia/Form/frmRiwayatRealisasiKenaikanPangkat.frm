...
Begin VB.Form frmRiwayatRealisasiKenaikanPangkat 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Realisasi Kenaikan Pangkat"
   ClientHeight    =   8460
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatRealisasiKenaikanPangkat.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatRealisasiKenaikanPangkat.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatRealisasiKenaikanPangkat.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatRealisasiKenaikanPangkat.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatRealisasiKenaikanPangkat"
...
Private Sub cmdSimpan_Click()
    ...
    If Periksa("datacombo", dcPangkat, "Nama pangkat usulan kosong ") = False Then Exit Sub
...
Private Sub subLoadRiwayatRealisasi()
    ...
    "dbo.RiwayatRealisasiUsulan.TandaTanganSK, dbo.RiwayatRealisasiUsulan.KdPangkatDiSetujui, dbo.Pangkat.NamaPangkat, dbo.GolonganPegawai.NamaGolongan, " & _
    ...
    "dbo.Pangkat ON dbo.RiwayatRealisasiUsulan.KdPangkatDiSetujui = dbo.Pangkat.KdPangkat INNER JOIN " & _
    "dbo.GolonganPegawai ON dbo.Pangkat.KdGolongan = dbo.GolonganPegawai.KdGolongan " & _
    "WHERE (dbo.RiwayatRealisasiUsulan.KdPangkatDiSetujui Is Not Null) " & _
    ...
    With dgData
        ...
        .Columns(9).Width = 1000 'tgl disetujui
        .Columns(10).Width = 1000 'tgl berlaku
    End With
    Exit Sub
errLoad:
    Call msubPesanError
...
Private Function sp_RiwayatRealisasi() As Boolean
    ...
    With adoComm
        ...
        .Parameters.Append .CreateParameter("KdPangkatDiSetujui", adVarChar, adParamInput, 2, dcPangkat.BoundText)
