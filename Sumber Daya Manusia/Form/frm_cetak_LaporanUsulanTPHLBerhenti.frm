...
Begin VB.Form frm_cetak_LaporanUsulanTPHLBerhenti 
   Caption         =   "Medifirst2000 - Cetak Laporan Tahunan Usulan Pengangkatan TPHL"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7950
   Icon            =   "frm_cetak_LaporanUsulanTPHLBerhenti.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   7950
   ...
   End
End
Attribute VB_Name = "frm_cetak_LaporanUsulanTPHLBerhenti"
...
Dim Report As New crLaporanUsulanTPHLBerhenti

Private Sub Form_Load()
    On Error GoTo errLoad
    Screen.MousePointer = vbHourglass
    Me.WindowState = 2
    Set frm_cetak_LaporanUsulanTPHLBerhenti = Nothing
    ...
    With Report
        ...
        .UnboundNumber1.SetUnboundFieldSource ("{ado.U55Thn}")
        .UnboundNumber2.SetUnboundFieldSource ("{ado.Meninggal}")
        .UnboundNumber3.SetUnboundFieldSource ("{ado.NonAktif}")
        .UnboundNumber4.SetUnboundFieldSource ("{ado.Lain2}")
        .usKeterangan.SetUnboundFieldSource ("{ado.KeteranganLainnya}")
        .txtTahun.SetText Format(frmLaporanRiwayatUsulanTPHLBerhenti.DTPickerAwal.Value, "yyyy")
