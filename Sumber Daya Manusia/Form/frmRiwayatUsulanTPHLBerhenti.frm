...
Begin VB.Form frmRiwayatUsulanTPHLBerhenti 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Riwayat Usulan Pemberhentian Tenaga Pegawai Harian Lepas (TPHL)"
   ClientHeight    =   8475
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9735
   Icon            =   "frmRiwayatUsulanTPHLBerhenti.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7920
      Picture         =   "frmRiwayatUsulanTPHLBerhenti.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmRiwayatUsulanTPHLBerhenti.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmRiwayatUsulanTPHLBerhenti.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmRiwayatUsulanTPHLBerhenti"
...
Private Sub cmdSimpan_Click()
    ...
    If Periksa("datacombo", dcStatus, "Silahkan isi status usulan ") = False Then Exit Sub
    If Periksa("datacombo", dcAlasan, "Silahkan isi alasan status usulan ") = False Then Exit Sub
...
Private Sub dgData_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    With dgData
        ...
        dcAlasan.BoundText = .Columns(8).Value
...
Private Sub dcStatus_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then dcAlasan.SetFocus
End Sub
...
Sub SetComboAlasanStatus()
    On Error GoTo hell
    Set rs = Nothing
    rs.Open "Select KdAlasanStatus, AlasanStatus from AlasanStatusPegawai order by AlasanStatus ", dbConn, , adLockOptimistic
    Set dcAlasan.RowSource = rs
    dcAlasan.ListField = rs.Fields(1).Name
    dcAlasan.BoundColumn = rs.Fields(0).Name
    Set rs = Nothing
    Exit Sub
hell:
    Call msubPesanError
