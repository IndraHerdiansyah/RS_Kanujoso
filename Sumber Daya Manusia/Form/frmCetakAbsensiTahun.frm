...
Begin VB.Form frmCetakAbsensiTahun 
   Caption         =   "Cetak Absensi Pegawai"
   ClientHeight    =   3120
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   4680
   Icon            =   "frmCetakAbsensiTahun.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3120
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmCetakAbsensiTahun"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim rptCetakAbsensi As CrLapAbsensiTahun
...
Private Sub Form_Load()
    ...
    Set rptCetakAbsensi = New CrLapAbsensiTahun
    ...
    With rptCetakAbsensi
        ...
        .usTotal.SetUnboundFieldSource ("{Ado.TotalAbsensi}")
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmCetakAbsensiTahun = Nothing
End Sub
