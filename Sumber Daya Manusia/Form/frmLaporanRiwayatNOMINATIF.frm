...
Begin VB.Form frmLaporanRiwayatNOMINATIF 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst 2000 - Laporan Tahunan Nominatif Pegawai"
   ClientHeight    =   2895
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3810
   ...
   EndProperty
   Icon            =   "frmLaporanRiwayatNOMINATIF.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   2880
      Picture         =   "frmLaporanRiwayatNOMINATIF.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1155
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanRiwayatNOMINATIF.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanRiwayatNOMINATIF.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12375
   End
End
Attribute VB_Name = "frmLaporanRiwayatNOMINATIF"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = "select * from V_LaporanNominatifPegawai where year(TglKeluar) < '" & Format(DTPickerAwal.Value, "yyyy") & "' OR TglKeluar is null "
    ...
    frm_cetak_LaporanNominatif.Show
    Exit Sub
errLoad:
End Sub
