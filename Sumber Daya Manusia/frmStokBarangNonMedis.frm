...
Sub subLoadGridSource()
    ...
    " WHERE NamaBarang LIKE '%" & txtCariBarang & "%' AND DetailJenisBarang LIKE '%" & txtCariJenisBarang & "%' AND NamaAsal LIKE '%" & txtCariAsalBarang & "%'AND kdRuangan = '" & mstrKdRuangan & "' AND NoRegisterAsset <> '000000' AND NoRegisterAsset <> '0000000'"
