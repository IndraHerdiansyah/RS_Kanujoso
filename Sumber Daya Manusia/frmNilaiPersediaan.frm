...
'    strSQL = "SELECT DISTINCT Lokasi, Lokasi AS Alias FROM MasterBarang ORDER BY Lokasi"
'    Call msubDcSource(dcLokasiBarang, rs, strSQL)
...
'Dim i As Integer
'
'    txtTotalStokSystem.Text = 0
'    txtHargaNetto1System.Text = 0
'    txtHargaNetto2System.Text = 0
'    txtTotalSystem.Text = 0
'
'    txtTotalStokReal.Text = 0
'    txtHargaNetto1Real.Text = 0
'    txtHargaNetto2Real.Text = 0
'    txtTotalReal.Text = 0
'
'    For i = 1 To fgData.Rows - 1
'        txtTotalStokSystem.Text = txtTotalStokSystem.Text + CInt(fgData.TextMatrix(i, 4))
'        txtHargaNetto1System.Text = txtHargaNetto1System.Text + CCur(fgData.TextMatrix(i, 6))
'        txtHargaNetto2System.Text = txtHargaNetto2System.Text + CCur(fgData.TextMatrix(i, 7))
'        txtTotalSystem.Text = txtTotalSystem.Text + (CInt(fgData.TextMatrix(i, 4)) * CCur(fgData.TextMatrix(i, 6)))
'
'        txtTotalStokReal.Text = txtTotalStokReal.Text + CInt(fgData.TextMatrix(i, 5))
'        txtHargaNetto1Real.Text = txtHargaNetto1Real.Text + CCur(fgData.TextMatrix(i, 6))
'        txtHargaNetto2Real.Text = txtHargaNetto2Real.Text + CCur(fgData.TextMatrix(i, 7))
'        txtTotalReal.Text = txtTotalReal.Text
'    Next i
'
'    txtTotalStokSystem.Text = Format(txtTotalStokSystem.Text, "#,###")
'    txtHargaNetto1System.Text = Format(txtHargaNetto1System.Text, "#,###.00")
'    txtHargaNetto2System.Text = Format(txtHargaNetto2System.Text, "#,###.00")
'    txtTotalSystem.Text = Format(txtTotalSystem.Text, "#,###.00")
'
'    txtTotalStokReal.Text = Format(txtTotalStokReal.Text, "#,###")
'    txtHargaNetto1Real.Text = Format(txtHargaNetto1Real.Text, "#,###.00")
'    txtHargaNetto2Real.Text = Format(txtHargaNetto2Real.Text, "#,###.00")
...
'            Call msubRecFO(dbRst, strSQL)
    ...
    Next i
    txtTotalStokReal.Text = Format(txtTotalStokReal.Text, "#,##0.0#")
    txtTotalReal.Text = Format(txtTotalReal.Text, "#,###.00")
...
'            .SetFocus
'            .Text = IIf(fgData.TextMatrix(fgData.Row, fgData.Col) = "", "__/__/____", fgData.TextMatrix(fgData.Row, fgData.Col))
'            .SelStart = 0
